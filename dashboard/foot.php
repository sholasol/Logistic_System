 <footer class="page-footer">
     <div class="font-13"><?php echo date('Y') ?> © <b>LogisticApp</b> - All rights reserved.</div>
 ...
 <?php 
 $q = dbConnect()->prepare("SELECT sum(amount) AS amount, created FROM payment WHERE WEEKOFYEAR(created) = WEEKOFYEAR(now()) GROUP BY created ");
 $q->execute();
 

 $q2 = dbConnect()->prepare("SELECT count(id) AS count, created FROM send WHERE WEEKOFYEAR(created) = WEEKOFYEAR(now()) GROUP BY created ");
 $q2->execute();

 $q3 = dbConnect()->prepare("SELECT sum(amount) AS amount FROM payment WHERE WEEKOFYEAR(created) = WEEKOFYEAR(now()) GROUP BY created ");
 $q3->execute();
 ?>
...
<!--    <script src="./assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script>-->
    ...
    var a = {
            ...
            labels: [<?php while($ro=$q->fetch()){echo ' " '.$ro['created'].' ", ';} ?>],
            datasets: [{
                label: "Weekly Income",
                borderColor: 'rgba(52,152,219,1)',
                backgroundColor: 'rgba(52,152,219,1)',
                pointBackgroundColor: 'rgba(52,152,219,1)',
                data: [<?php while($rr=$q3->fetch()){echo ' " '.$rr['amount'].' ", ';} ?>]
                //data: [29, 48, 40, 19, 78, 31, 85]
            },{
                label: "Weekly Delivery",
                backgroundColor: "#DADDE0",
                borderColor: "#DADDE0",
                data: [<?php while($rw=$q2->fetch()){echo ' " '.$rw['count'].' ", ';} ?>]
  ...
  var doughnutData = {
      labels: ["Paid","Pending","Refund" ],
      datasets: [{
          data: [<?php echo $pPaid ?>,<?php echo $pPend ?>,<?php echo $pRefund ?>],
          backgroundColor: ["#080","rgb(54, 162, 235)","#f1a417"]
      }]
  } ;
