            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Administrator Setup</div>
                            </div>
                            <div class="ibox-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 ml-sm-auto">
                                        <button class="btn btn-info" type="submit" name="save">Add Admin User</button>
                                    </div>
                                </div>
                            </form>
                            </div>
                ...
                <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Administrators</div>
                            </div>
                            <div class="ibox-body">
