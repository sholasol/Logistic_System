            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Deliveries (YTD)</div>
                            </div>
                            <div class="ibox-body">
                          <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $sn=  dbConnect()->prepare("SELECT * FROM send, payment WHERE send.tracking = payment.tracking AND YEAR(send.created) = YEAR(now())");
                                $counter=0;
                                $sn->execute();
                                while($r=$sn->fetch()){
                                ?>
