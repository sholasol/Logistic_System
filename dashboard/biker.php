       ...
       if(empty($_POST['fname'])){
        ...
        elseif(empty ($_POST['phone'])){
            ...
            $hash= password_hash($pas, PASSWORD_BCRYPT, $options);
                ...
                $ins=  dbConnect()->prepare("INSERT INTO users SET role=:role, fname=:fn, lname=:ln, phone=:phn, email=:em, password=:pwd, branch=:brn, compID=:comp, joined=:date, createdby=:by");
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Rider Setup</div>
                            </div>
                            <div class="ibox-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 ml-sm-auto">
                                        <button class="btn btn-info" type="submit" name="save">Add Rider</button>
                                    </div>
                                </div>
                            </form>
                            </div>
                ...
                <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Recent Riders</div>
                            </div>
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0" style="background: #fff !important;">
                                <?php
                                $sl=dbConnect()->query("SELECT * FROM users WHERE compID='$comp' AND role=3 ORDER BY userID DESC LIMIT 5");
                                $sl->execute();
                                while($r=$sl->fetch()){
                                ?>
                                <li class="media">
