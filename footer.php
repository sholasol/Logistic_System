...
<section class="footer">
    ...
    <div class="footer-block col-md-3 col-sm-3 cf">
      <div class="mpd-logo-text"><img src="dashboard/logo-image/image_logo.php?id=1" height="45" width="241" /></div>  
    </div>
    ...
    <div class="footer-block col-md-3 col-sm-3">
        ...
        <ul class="hidden-xs">
            ...
            <li><a href="comparison.php" tabindex="-1">Royal Mail Comparison</a></li>
        </ul>
    </div>
...
<div class="fw footer-dark">
    <section class="footer footer-baseline">
        <p class="footer-text mob-me">&copy; Copyright <?php echo date('Y');?> DEPRIXA PRO</p>
